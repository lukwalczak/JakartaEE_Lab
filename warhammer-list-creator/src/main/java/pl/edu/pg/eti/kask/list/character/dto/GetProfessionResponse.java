package pl.edu.pg.eti.kask.list.character.dto;
 ...
 * {@link pl.edu.pg.eti.kask.list.character.entity.Profession}.
 */
@Getter
@Setter
@Builder
...
public class GetProfessionResponse {
     ...
     * skills are described is defined in {@link pl.edu.pg.eti.kask.list.character.entity.Skill}.
     */
    @Getter
    @Setter
    @Builder
