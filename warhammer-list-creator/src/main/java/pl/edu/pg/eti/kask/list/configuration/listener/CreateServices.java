...
import pl.edu.pg.eti.kask.list.character.repository.api.CharacterRepository;
import pl.edu.pg.eti.kask.list.character.repository.api.ProfessionRepository;
import pl.edu.pg.eti.kask.list.character.repository.memory.CharacterInMemoryRepository;
import pl.edu.pg.eti.kask.list.character.repository.memory.ProfessionInMemoryRepository;
